...
> Мы не несем ответственности за igs-core, который установлен в addons и не оказываем в таких случаях бесплатную [поддержку](https://igs-gmod.ru/support). Вам также не будут приходить автоматические обновления.

Код из этой папки скачивается автоматически, если вы установили автодонат [по инструкции](https://igs-gmod.ru/instructions).
...
Если возникли вопросы или проблемы с правильной установкой, то вы можете задать их [здесь](https://forum.igs-gmod.ru/c/support/troubleshooting/15). Рекомендуем сразу приложить console.log и `garrysmod/data/igs_errors.txt`
